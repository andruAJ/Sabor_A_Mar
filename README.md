...
* Inventory: It's… An inventory, it stores the food you collect.
* FoodElement: A simple script, since the inventory is pretty simple and minimal. It sets a name based on the objects tag
